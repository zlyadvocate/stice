...
static stice_agent_t *agent;
static bool success = false;
static bool done = false;

static void on_state_changed(stice_agent_t *agent, stice_state_t state, void *user_ptr);
static void on_candidate(stice_agent_t *agent, const char *sdp, void *user_ptr);
static void on_gathering_done(stice_agent_t *agent, void *user_ptr);
